...
def fidelityCenterSearch(ps5):
    ...
    ps5_link = "https://www.fidelitycenter.com.cy/product/sony-playstation-5-ps5/"
    
    if ps5 == "digital":
        ps5_name = "Digital Edition"
        ps5_link = "https://www.fidelitycenter.com.cy/product/sony-playstation-5-ps5-digital-edition/"
