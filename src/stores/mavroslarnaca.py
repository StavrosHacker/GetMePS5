...
def mavrosLarnacaSearch(ps5):
    site_domain = "mavroslarnaca.com"
    ps5_name = "Disc Edition"
    ps5_link = "https://www.mavroslarnaca.com/product-page/ps5-console"

    if ps5 == "digital":
        ps5_name = "Digital Edition"
        ps5_link = "https://www.mavroslarnaca.com/product-page/ps5-console-digital-edition"
